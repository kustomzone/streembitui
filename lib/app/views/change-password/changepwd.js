        ...
        function (ko, i18next, appsrvc, user, appevents, accounts, template) {
            ...
            function ChangePwdVm(params) {
                ...
                if (!appsrvc.account_connected) {
                    ...
                    return doorclient.notify.error("To change the password first you must initialize your account");
                }
                ...
                this.submit = function () {
                    try {
                        ...
                        user.change_password(this.current_account, password, function (err) {
                            if (err) {
                                return doorclient.notify.error("Error in changing password: %j", err);
                            }

                            doorclient.notify.info("The password for account " + self.accountname() + " was changed");
                        ...
                        doorclient.notify.error("Error in changing the password: %j", err);
                    }
                };
            }
