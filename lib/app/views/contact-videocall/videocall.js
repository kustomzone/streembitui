                ...
                var viewModel = {
                    ...
                    dispose: function () {
                        try {
                            ...
                            doorclient.notify.error("VideoCallVM dispose %j", err, true);
                        }
                    },
                    ...
                    onPeerHangup: function () {
                        ...
                        doorclient.notify.info("The call has been terminated by the contact", null, true);
                    },
                    ...
                    sendfile: function () {
                        if (!peercomm.is_peer_session(viewModel.contact.name)) {
                            return doorclient.notify.error_popup("Invalid contact session");
                        }
                    ...
                    showchat: function () {
                        ...
                        try {
                            ...
                            connections.create(viewModel.contact, true, taskid, function (err, webrtcconn) {
                                ...
                                if (!webrtcconn) {
                                    reported = true;
                                    return doorclient.notify.error("Error in starting chat, no WebRTC connection", null, true);
                                }
                    ...
                    sendchat: function () {
                        try {
                            ...
                            doorclient.notify.error("Send chat error %j", err, true);
                        }
                    },
