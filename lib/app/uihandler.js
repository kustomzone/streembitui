...
(function () {
    ...
    var uihandler = {
        ...
        loaddiv: ("#" + doorclient.ui.load_container),
        maindiv: ("#" + doorclient.ui.main),
        taskbar: ("#" + doorclient.ui.taskbarmsg),
        ...
        init: function (knockout, jquery) {
            ...
            doorclient.notify.error = function (err, param, istaskbar) {
                if (!err) { return; }
            ...
            doorclient.notify.success = function (msg, param, istaskbar) {
            ...
            doorclient.notify.info = function (msg, param, istaskbar) {
                var text = self.get_msg(msg, param);
                if (!istaskbar) {
            ...
            doorclient.notify.hideprogress = function () { }

            doorclient.ui.set_account_title = function (account) {
                document.title = (doorclient.globals.appname || "DoorClient") + " - " + account;
            };           

            doorclient.ui.reset_title = function (account) {
                document.title = (doorclient.globals.appname || "DoorClient");
            };    
        },
        ...
        set_load_info: function (value, nolog) {
            ...
            $("#" + doorclient.ui.load_info).text(text);
            try {
                if (!nolog) {
                    logger.info(text);
                }
        ...
        on_appload_error: function (error) {
            var msg = "Loading DoorClient application failed. ";
